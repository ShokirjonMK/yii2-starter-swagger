            ...
            <nav class="mt-2">
                <?php echo MainSidebarMenu::widget([
                    ...
                    'items' => [
                        ...
                        [
                            'label' => Yii::t('backend', 'marketplace'),
                            'icon' => FAS::icon('store', ['class' => ['nav-icon']]),
                            'url' => ['/marketplace/supplier-buyer/index'],
                            'active' => Yii::$app->controller->id === 'marketplace',
                            'visible' => Yii::$app->user->can('administrator'),
                        ],
                        [
                            'label' => Yii::t('backend', 'webhook'),
                            'icon' => FAS::icon('plug', ['class' => ['nav-icon']]),
                            'url' => ['/marketplace/webhook/index'],
                            'active' => Yii::$app->controller->id === 'webhook',
                            'visible' => Yii::$app->user->can('administrator'),
                        ],
                        ...
                        [
                            'label' => Yii::t('backend', 'RateLimit'),
                            'url' => ['/system/rate-limit/index'],
